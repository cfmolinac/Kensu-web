      ...
      <main>
        ...
        <section className="relative bg-gradient-to-br from-green-50 via-white to-orange-50 pt-32 pb-20 overflow-hidden">
          ...
          <div className="container mx-auto px-6 text-center relative z-10">
            <div className="inline-block mb-4 px-4 py-2 bg-kensu-blue/10 rounded-full border border-kensu-blue/20">
              <span className="text-kensu-blue font-semibold text-sm">🚀 Kensu Lab</span>
            </div>
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 text-lg leading-relaxed mb-4">
                En <strong className="text-kensu-blue">Kensu Lab</strong>, nacimos de una realidad que compartimos millones de padres: la sensación de que, a pesar de vivir en un mundo hiperconectado, la gestión escolar de nuestros hijos se ha vuelto una <strong>fuente de carga mental abrumadora</strong>. Grupos de WhatsApp interminables, correos traspapelados y la eterna pregunta: <em>"¿Qué tengo que comprar para mañana?"</em>.
              </p>
              <p className="text-gray-600 text-lg leading-relaxed">
                No fundamos Kensu para ser una aplicación más en tu teléfono. La fundamos para ser el <strong className="text-kensu-green">filtro inteligente</strong> que separa el ruido de la información relevante, devolviéndote lo más valioso: <strong>tiempo y tranquilidad</strong>.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto mb-16">
              ...
              <p className="text-gray-600 text-lg text-center leading-relaxed">
                Kensu Lab es liderado por dos ingenieros de la Universidad Católica de Chile, que combinan el rigor técnico con la experiencia real del mundo empresarial y la vida familiar.
              </p>
            </div>
