...
export default function HeroSection() {
  return (
    <section id="hero" className="relative bg-gradient-to-br from-green-50 via-white to-orange-50 h-[850px] overflow-hidden pt-80 lg:pt-0">
      ...
      <div className="container mx-auto px-6 h-full flex flex-col justify-center text-center lg:text-left lg:flex-row items-center">
        <div className="lg:w-1/2 z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
            <div className="relative flex-1 sm:flex-none">
              <a href="#" className="flex items-center justify-center bg-kensu-green text-white px-6 py-3 rounded-lg opacity-60 cursor-not-allowed shadow-xl w-full sm:w-auto" onClick={(e) => e.preventDefault()}>
            ...
            <div className="relative flex-1 sm:flex-none">
              <a href="#" className="flex items-center justify-center bg-kensu-orange text-white px-6 py-3 rounded-lg opacity-60 cursor-not-allowed shadow-xl w-full sm:w-auto" onClick={(e) => e.preventDefault()}>
        ...
        <div className="lg:w-1/2 mt-20 lg:mt-0 flex justify-center items-center h-full">
          <div className="relative w-[350px] h-[700px]">
            ...
            <div className="absolute inset-0 px-[26px] py-[24px] overflow-hidden">
              <Image
                src={`/assets/images/screenshots/20260107-app-screen.png?v=${process.env.BUILD_ID}`}
